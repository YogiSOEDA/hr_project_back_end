package com.dimata.service.general.hairisma.core.util;

import com.dimata.service.general.hairisma.exception.FormatException;
...
public class FormatUtil {
  ...
  public static LocalDate convertDateToLocalDate(String date, String dateFormat) {
    try {
      ...
      throw new FormatException("Format tanggal harus " + dateFormat + ". Contoh : 29-08-2002");
    }
  }
